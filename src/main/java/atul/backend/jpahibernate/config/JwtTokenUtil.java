...
public class JwtTokenUtil implements Serializable {
    ...
    private Claims getAllClaimsFromToken(String token) {
        return Jwts.parser()
                .setSigningKey(Const.JWT.SIGNING_KEY)
    ...
    private String doGenerateToken(String subject) {
        ...
        return Jwts.builder()
                ...
                .setExpiration(new Date(System.currentTimeMillis() + Const.JWT.ACCESS_TOKEN_VALIDITY_SECONDS*1000))
                .signWith(SignatureAlgorithm.HS256, Const.JWT.SIGNING_KEY)
                .compact();
    }
